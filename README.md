# My New Kotlin JVM Project

This is an **opinionated** template for creating kotlin jvm projects.

This works for me and might help you bootstrap your kotlin projects.

## Batteries included

My goal with this is to waste less time setting up new projects. Kotlin and gradle can be a bit fiddly/challenging to get going with and there are a lot of things that I want to add to projects. This gets me there with minimal fiddling.
...
- [ ] Change your project name by changing `rootProject.name = "my-kotlin-jvm-project"` in settings.gradle.kts. 
...
- [ ] Address the FIXMEs in `build.gradle.kts` and `ReadmeGenerationTest` and elsewhere.
